    ...
    <div class="row mb-3">
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_number" class="formlabel form-label"><i class="fas fa-id-card"></i> EMPLOYEE NO. <span class="span_employee_number span_all">(Required)</span></label>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="company_of_employee" class="formlabel form-label"><i class="fas fa-info"></i> COMPANY <span class="span_company_of_employee span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="branch_of_employee" class="formlabel form-label"><i class="fas fa-info"></i> BRANCH <span class="span_branch_of_employee span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="status_of_employee" class="formlabel form-label"><i class="fas fa-info"></i> STATUS <span class="span_status_of_employee span_all">(Required)</span></label>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="f-outline">
                ...
                <label for="shift_of_employee" class="formlabel form-label"><i class="fas fa-clock"></i> SHIFT <span class="span_shift_of_employee span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="position_of_employee" class="formlabel form-label"><i class="fas fa-info"></i> POSITION <span class="span_position_of_employee span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="supervisor_of_employee" class="formlabel form-label"><i class="fas fa-user-tie"></i> SUPERVISOR <span class="span_supervisor_of_employee span_all">(Required)</span></label>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="f-outline">
                ...
                <label for="date_hired" class="formlabel form-label"><i class="fas fa-calendar" aria-hidden="true" ></i> DATE HIRED <span class="span_date_hired span_all">(Required)</span></label> 
            </div>
        </div>
        <div class="col">
            <div class="f-outline">
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="f-outline">
                    ...
                    <label for="sss_number" class="formlabel form-label"><i class="fas fa-hashtag" aria-hidden="true"></i> SSS Number <span class="span_sss_number span_all">(Required)</span></label>
                </div>
            </div>
            <div class="col">
                <div class="f-outline">
                    ...
                    <label for="pag_ibig_number" class="formlabel form-label"><i class="fas fa-hashtag"></i> PAG-IBIG NO. <span class="span_pag-ibig_number span_all">(Required)</span></label>
                </div>
            </div>
            <div class="col">
                <div class="f-outline">
                    ...
                    <label for="philhealth_number" class="formlabel form-label"><i class="fas fa-hashtag"></i> PHILHEALTH NO. <span class="span_philhealth_number span_all">(Required)</span></label>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-4">
                <div class="f-outline">
                    ...
                    <label for="tin_number" class="formlabel form-label"><i class="fas fa-hashtag"></i> TIN NO. <span class="span_tin_number span_all">(Required)</span></label>
                </div>
            </div>
            <div class="col-4">
                <div class="f-outline">
                    ...
                    <label for="account_number" class="formlabel form-label"><i class="fas fa-hashtag"></i> BANK ACCOUNT NO. <span class="span_account_number span_all">(Required)</span></label>
                </div>
            </div>
        </div>
    </div>
