    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_company" class="formlabel form-label"><i class="fas fa-info"></i> COMPANY <span class="span_company_of_employee span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_branch" class="formlabel form-label"><i class="fas fa-info"></i> BRANCH <span class="span_employee_branch span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_status" class="formlabel form-label"><i class="fas fa-info"></i> STATUS <span class="span_employee_status span_all">(Required)</span></label>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_shift" class="formlabel form-label"><i class="fas fa-clock"></i> SHIFT <span class="span_employee_shift span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_position" class="formlabel form-label"><i class="fas fa-info"></i> POSITION <span class="span_employee_position span_all">(Required)</span></label>
            </div>
        </div>
        ...
        <div class="col">
            <div class="f-outline">
                ...
                <label for="employee_supervisor" class="formlabel form-label"><i class="fas fa-user-tie"></i> SUPERVISOR <span class="span_employee_supervisor span_all">(Required)</span></label>
            </div>
        </div>
    </div>
