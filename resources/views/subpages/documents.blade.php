                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input  type="file"   id="nbi_file"   class="required_field"     onchange="return nbiValidation()" accept="image/*,.pdf" name="nbi_file">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input  type="file"   id="barangay_clearance_file"   class="required_field"     onchange="return barangayclearanceValidation()" accept="image/*,.pdf" name="barangay_clearance_file">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input  type="file"   id="police_clearance_file"   class="required_field"     onchange="return policeclearanceValidation()" accept="image/*,.pdf" name="police_clearance_file">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input  type="file"   id="philhealth_file"   class="required_field"     onchange="return philhealthValidation()" accept="image/*,.pdf" name="philhealth_file">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="file"     id="pag_ibig_file"   class="required_field"     onchange="return pagibigValidation()"accept="image/*,.pdf" name="pag_ibig_file">
