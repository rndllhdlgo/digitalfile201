            ...
            <div class="row mb-3">
                <div class="col">
                        <div class="f-outline">
                            ...
                            <label for="emergency_contact_name" class="formlabel form-label"><i class="fa fa-id-card" aria-hidden="true"></i> INCASE OF EMERGENCY NAME <span class="span_emergency_contact_name span_all">(Required)</span> </label>
                        </div>
                </div>
                <div class="col">
                    <div class="f-outline">
