        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="f-outline">
                        <input class="forminput form-control required_field text-uppercase" type="search" id="supervisor_name" placeholder=" " style="background-color:white;" autocomplete="off">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="f-outline">
                        <input class="forminput form-control required_field text-uppercase" type="search" id="supervisor_name_new" placeholder=" " style="background-color:white;" autocomplete="off">
                        <p class="validation"><i class="fas fa-exclamation-triangle"></i> Supervisor Already Exist!</p>
