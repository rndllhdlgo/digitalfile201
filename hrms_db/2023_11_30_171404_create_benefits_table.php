...
return new class extends Migration
{
    ...
    {
        Schema::table('work_logs', function (Blueprint $table) {
            $table->dropForeign('FK_history_logs_personal_information_tables');
        });

        Schema::table('work_information_tables', function (Blueprint $table) {
            $table->dropForeign('FK_work_information_tables_personal_information_tables');
        });

        Schema::table('vocationals', function (Blueprint $table) {
            $table->dropForeign('FK_vocational_tables_personal_information_tables');
        });

        Schema::table('trainings', function (Blueprint $table) {
            $table->dropForeign('FK_training_tables_personal_information_tables');
        });

        Schema::table('termination', function (Blueprint $table) {
            $table->dropForeign('FK_termination_tables_personal_information_tables');
        });

        Schema::table('secondary_school', function (Blueprint $table) {
            $table->dropForeign('secondary_school_ibfk_1');
        });
        ...
        Schema::table('resignation', function (Blueprint $table) {
            $table->dropForeign('FK_resignation_tables_personal_information_tables');
        });

        Schema::table('primary_school', function (Blueprint $table) {
            $table->dropForeign('primary_school_ibfk_1');
        });
        ...
        Schema::table('memo', function (Blueprint $table) {
            $table->dropForeign('FK_memo_tables_personal_information_tables');
        });

        Schema::table('medical_histories', function (Blueprint $table) {
            $table->dropForeign('FK_medical_histories_personal_information_tables');
        });

        Schema::table('job_history', function (Blueprint $table) {
            $table->dropForeign('FK_job_history_tables_personal_information_tables');
        });

        Schema::table('hmo', function (Blueprint $table) {
            $table->dropForeign('hmo_ibfk_1');
        });

        Schema::table('evaluation', function (Blueprint $table) {
            $table->dropForeign('FK_evaluation_tables_personal_information_tables');
        });

        Schema::table('employee_logs', function (Blueprint $table) {
            $table->dropForeign('FK_logs_tables_personal_information_tables');
        });

        Schema::table('educational_attainments', function (Blueprint $table) {
            $table->dropForeign('FK_educational_attainments_personal_information_tables');
        });

        Schema::table('documents', function (Blueprint $table) {
            $table->dropForeign('FK_documents_personal_information_tables');
        });

        Schema::table('college', function (Blueprint $table) {
            $table->dropForeign('FK_college_tables_personal_information_tables');
        });

        Schema::table('children', function (Blueprint $table) {
            $table->dropForeign('FK_children_tables_personal_information_tables');
        });

        Schema::table('benefits', function (Blueprint $table) {
            $table->dropForeign('FK_compensation_benefits_personal_information_tables');
        });
        ...
        Schema::dropIfExists('user_logs_copy');
        ...
        Schema::dropIfExists('secondary_school');
        ...
        Schema::dropIfExists('multiple_save');
