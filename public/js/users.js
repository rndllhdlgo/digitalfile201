...
$(document).ready(function () {
  ...
  $('#usersTable thead tr')// Setup - add a text input to each footer cell
      .clone(true)
      .addClass('filters')
    ...
    columns: [
      ...
      initComplete: function () {
          ...
          .each(function (colIdx) {
              ...
              $(cell).html('<input type="text" style="border-color:white;border-radius:5px;width:100%;"/>');// On every keypress in this input
